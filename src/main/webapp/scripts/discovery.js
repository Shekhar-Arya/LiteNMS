...
let addRow ;
    ...
    onGetDiscoveryDeviceSuccess: function (request){
        ...
        $.each(request.data.result.result,function (i,v){
            ...
            addRow.row.add([v.id,v.name,v.ip,v.type,'<button class="btn btn-outline-primary btn-sm pingDiscoveryDevice" data-id="'+v.id+'"><i class="bi bi-play-btn"></i></button> <button class="btn btn-outline-primary btn-sm editDiscoveryRow" data-id="'+v.id+'"><i class="bi bi-pencil-square"></i></button> <button class="btn btn-outline-primary btn-sm deleteDiscoveryRow" data-id="'+v.id+'"><i class="bi bi-trash2"></i></button>']).draw();
